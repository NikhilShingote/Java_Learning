...
// it is a combination of extends and implements
// here a class will implements 2 interfaces and 1 class
...
{	
	...
	public void m2()  // this is m2 method from B1 interface
	{
		System.out.println("this is m2 method from B1 interface");
	}
	
	
	public void m3()    // this is m3 method from B2 interface
	{
